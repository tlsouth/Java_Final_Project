...
public class SOS_Final extends JFrame
{
	...
	private JLabel deathMsg = new JLabel ("Oh no, you've died! Close this window and hit 'Start' to try again!");
	...
	public void decreaseSeq()
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Oh no! You've died! Close this window and hit 'Start' to try again!");
			updatePrompt("You've lost your sequence and died!\n Hit 'Start' to try again!");
	...
	public void openingScene()
	{
		...
		updatePrompt(name + "! On your NASA-sponsored mission to find life in outerspace, your rocket ship "
			+ "failed due to faulty coding and you crash-landed onto another planet. You now must fight your way through this unknown land "
	...
	public void eventSeven()
	{
		...
		updatePrompt("After you catch your breath from crossing the river, you realize the cliffside on which the ship is perched is nearby. "
				...
				+ "For old time’s sake, you could decide to climb up the cliffside one more time, or "
				+ "you could enjoy the beauty of this planet one last time as you hike your way up the cliffside to the ship. "
				+ "Along the way you may find some berries and mushrooms and have a small snack as you reach the top");
	...
	public void maroonedEnding()
	{
		...
		homeScreen.setIcon(image);
		updatePrompt("The ship doesn't open for you, so you climb back down the cliff and live the rest of your days trying to learn underwater basketweaving.");
		option1.setEnabled(false);
		option2.setEnabled(false);
		start.setEnabled(false);
	}
